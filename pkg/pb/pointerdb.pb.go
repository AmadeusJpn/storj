...
type ListRequest struct {
	Prefix     Path   `protobuf:"bytes,1,opt,name=prefix,proto3,casttype=Path" json:"prefix,omitempty"`
	StartAfter Path   `protobuf:"bytes,2,opt,name=start_after,json=startAfter,proto3,casttype=Path" json:"start_after,omitempty"`
	EndBefore  Path   `protobuf:"bytes,3,opt,name=end_before,json=endBefore,proto3,casttype=Path" json:"end_before,omitempty"`
...
func (m *ListRequest) GetPrefix() Path {
	if m != nil {
		return m.Prefix
	}
	return ""
...
func (m *ListRequest) GetStartAfter() Path {
	if m != nil {
		return m.StartAfter
	}
	return ""
...
func (m *ListRequest) GetEndBefore() Path {
	if m != nil {
		return m.EndBefore
	}
	return ""
...
func (m *ListResponse_Item) GetPath() Path {
	if m != nil {
		return m.Path
	}
	return ""
...
type IterateRequest struct {
	Prefix  Path `protobuf:"bytes,1,opt,name=prefix,proto3,casttype=Path" json:"prefix,omitempty"`
	First   Path `protobuf:"bytes,2,opt,name=first,proto3,casttype=Path" json:"first,omitempty"`
...
func (m *IterateRequest) GetPrefix() Path {
	if m != nil {
		return m.Prefix
	}
	return ""
...
func (m *IterateRequest) GetFirst() Path {
	if m != nil {
		return m.First
	}
	return ""
...
var fileDescriptorPointerdb = []byte{
	...
	,
}
